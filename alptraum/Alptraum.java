...
//		alpMultiItem = new AlptraumItem(InmMulti1).setItemName("alpMulitItem1");
	...
	private void initOthers()
	{
		...
		EntityRegistry.registerGlobalEntityID(_bau5.alptraum.EntityTorch.class, "Torch", EntityRegistry.findGlobalUniqueEntityId());
		RenderingRegistry.registerEntityRenderingHandler(_bau5.alptraum.EntityTorch.class, new EntityTorchRenderer(new EntityTorchModel(), 0.5F));
	}
